...
export function UsersView({ user, onClose, isOpen }: UsersViewProps) {
        ...
        <div className="space-y-6">
            ...
            <div className="flex-grow">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">User ID: {user.id}</p>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg">
                  <MailOutlined className="w-5 h-5 text-slate-600 dark:text-slate-400" />
                </div>
                <div className="flex-1">
                  <p className="text-xs text-slate-500 dark:text-slate-400">Email</p>
                  <p className="text-sm text-slate-900 dark:text-slate-100 break-all">{user.email}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-700/30 rounded-xl p-5">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg">
                  <UserOutlined className="w-5 h-5 text-slate-600 dark:text-slate-400" />
                </div>
                <div className="flex-1">
                  <p className="text-xs text-slate-500 dark:text-slate-400">User ID</p>
                  <p className="text-sm text-slate-900 dark:text-slate-100">#{user.id}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg">
                  <CalendarOutlined className="w-5 h-5 text-slate-600 dark:text-slate-400" />
                </div>
                <div className="flex-1">
                  <p className="text-xs text-slate-500 dark:text-slate-400">Created Date</p>
                  <p className="text-sm text-slate-900 dark:text-slate-100">{user.created_at}</p>
                </div>
              </div>
